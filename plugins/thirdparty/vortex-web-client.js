...
(function() {
  ...
  Runtime = (function() {
    function Runtime() {
      ...
      this.ctrlWorker = new Worker("/plugins/thirdparty/control-link.js");
      this.sendWorker = new Worker("/plugins/thirdparty/writer-link.js");
      this.rcvWorker = new Worker("/plugins/thirdparty/reader-link.js");
    ...
    Runtime.prototype.registerTopic = function(t) {
      var ct, eid;
      console.log("[Log]: Defining topic " + t.tinfo.tname);
